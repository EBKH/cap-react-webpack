...
config :cap_phoenix_react_webpack, CapPhoenixReactWebpackWeb.Endpoint,
  ...
  debug_errors: true,
  url: [scheme: "https", host: "react-cap.herokuapp.com", port: 443],
  force_ssl: [rewrite_on: [:x_forwarded_proto]],
  cache_static_manifest: "priv/webpack/build/cache_manifest.json",
...
# start per endpoint:
#
#     config :cap_phoenix_react_webpack, CapPhoenixReactWebpackWeb.Endpoint, server: true
#
